...
By contributing to Springier Life, you agree with the [Developer Certificate of Origin (DCO)][DCO].
...
Use American English to keep consistency across Springier Life.

If there is more than one acceptable spelling of the same word, first check if one word is already
being used in Springier Life, FrozenLib, or in Mojang's Mappings, and if not, use the spelling that is most commonly used.
...
Springier Life is licensed under [LGPL 3.0][LICENSE], and it has a [Developer Certificate of Origin (DCO)][DCO], which you are required to agree with to contribute.
...
[LICENSE]: ./LICENSE "Springier Life license file"
